 ...
 * http://polymer.github.io/PATENTS.txt
 */
"undefined"!=typeof window&&(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.3.0");const k=(t,...e)=>new f(t,e,"html",S),H=(t,e)=>k`
	<button
		class="btn badge"
		data-badge=${t}
...
`,P=document.getElementById("app");!function t(e){((t,e,s)=>{let i=C.get(e);void 0===i&&(n(e,e.firstChild),C.set(e,i=new w(Object.assign({templateFactory:M},s))),i.appendInto(e)),i.setValue(t),i.commit()})(H(e,()=>t(e+1)),P)}(0)}();