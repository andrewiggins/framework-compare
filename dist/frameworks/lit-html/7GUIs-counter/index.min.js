 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */;const $=new class{handleAttributeExpressions(t,e,s,n){const i=e[0];if("."===i){return new V(t,e.slice(1),s).parts}if("@"===i)return[new T(t,e.slice(1),n.eventContext)];if("?"===i)return[new w(t,e.slice(1),s)];return new x(t,e,s).parts}handleTextExpression(t){return new y(t)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
"undefined"!=typeof window&&(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.2.1");const k=(t,...e)=>new g(t,e,"html",$),L=(t,e)=>k`
	<button
		class="btn badge"
		data-badge=${t}
...
`,P=document.getElementById("app");!function t(e){((t,e,s)=>{let i=M.get(e);void 0===i&&(n(e,e.firstChild),M.set(e,i=new y(Object.assign({templateFactory:S},s))),i.appendInto(e)),i.setValue(t),i.commit()})(L(e,()=>t(e+1)),P)}(0)}();