 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */;const $=new class{handleAttributeExpressions(t,e,s,n){const i=e[0];if("."===i){return new w(t,e.slice(1),s).parts}return"@"===i?[new T(t,e.slice(1),n.eventContext)]:"?"===i?[new V(t,e.slice(1),s)]:new x(t,e,s).parts}handleTextExpression(t){return new y(t)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */function S(t){let e=C.get(t.type);void 0===e&&(e={stringsArray:new WeakMap,keyString:new Map},C.set(t.type,e));let s=e.stringsArray.get(t.strings);if(void 0!==s)return s;const n=t.strings.join(r);return s=e.keyString.get(n),void 0===s&&(s=new h(t,t.getTemplateElement()),e.keyString.set(n,s)),e.stringsArray.set(t.strings,s),s}const C=new Map,M=new WeakMap;
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.1.2");const L=(t,...e)=>new g(t,e,"html",$),k=(t,e,s,n)=>L`
	<input .value=${t} @input=${s} type="number" />
	°c =
	<input .value=${e} @input=${n} type="number" />
	°f
`,P=document.getElementById("app");!function t(e,s){((t,e,s)=>{let i=M.get(e);void 0===i&&(n(e,e.firstChild),M.set(e,i=new y(Object.assign({templateFactory:S},s))),i.appendInto(e)),i.setValue(t),i.commit()})(k(e,s,(function(n){e=n.target.value,s=+(32+1.8*e).toFixed(1),t(e,s)}),(function(n){s=n.target.value,t(e=+(5/9*(s-32)).toFixed(1),s)})),P)}("","")}();