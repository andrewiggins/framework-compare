 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */;const S=new class{handleAttributeExpressions(t,e,s,n){const i=e[0];if("."===i){return new b(t,e.slice(1),s).parts}if("@"===i)return[new A(t,e.slice(1),n.eventContext)];if("?"===i)return[new V(t,e.slice(1),s)];return new y(t,e,s).parts}handleTextExpression(t){return new w(t)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
"undefined"!=typeof window&&(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.3.0");const H=(t,...e)=>new f(t,e,"html",S),P=(t,e,s,n)=>H`
	<input .value=${t} @input=${s} type="number" />
	°c =
	<input .value=${e} @input=${n} type="number" />
	°f
`,k=document.getElementById("app");!function t(e,s){((t,e,s)=>{let i=C.get(e);void 0===i&&(n(e,e.firstChild),C.set(e,i=new w(Object.assign({templateFactory:M},s))),i.appendInto(e)),i.setValue(t),i.commit()})(P(e,s,(function(n){e=n.target.value,s=+(32+1.8*e).toFixed(1),t(e,s)}),(function(n){s=n.target.value,t(e=+(5/9*(s-32)).toFixed(1),s)})),k)}("","")}();