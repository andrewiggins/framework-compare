 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */;const $=new class{handleAttributeExpressions(t,e,s,n){const i=e[0];if("."===i){return new w(t,e.slice(1),s).parts}return"@"===i?[new T(t,e.slice(1),n.eventContext)]:"?"===i?[new b(t,e.slice(1),s)]:new x(t,e,s).parts}handleTextExpression(t){return new y(t)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */function S(t){let e=M.get(t.type);void 0===e&&(e={stringsArray:new WeakMap,keyString:new Map},M.set(t.type,e));let s=e.stringsArray.get(t.strings);if(void 0!==s)return s;const n=t.strings.join(r);return s=e.keyString.get(n),void 0===s&&(s=new h(t,t.getTemplateElement()),e.keyString.set(n,s)),e.stringsArray.set(t.strings,s),s}const M=new Map,C=new WeakMap;
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.1.2");const k=(t,...e)=>new g(t,e,"html",$),L=(t,e,s,n)=>k`
	<label>
...
`,P=document.getElementById("app");!function t(e,s,i){e<s&&requestAnimationFrame(n=>t(e+Math.min(n-i,s-e),s,n)),((t,e,s)=>{let i=C.get(e);void 0===i&&(n(e,e.firstChild),C.set(e,i=new y(Object.assign({templateFactory:S},s))),i.appendInto(e)),i.setValue(t),i.commit()})(L(e,s,s=>t(e,s.target.value,i),()=>t(0,s,performance.now())),P)}(0,5e3,performance.now())}();