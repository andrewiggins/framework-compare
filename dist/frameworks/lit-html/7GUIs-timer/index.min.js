 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */;const S=new class{handleAttributeExpressions(t,e,s,n){const i=e[0];if("."===i){return new V(t,e.slice(1),s).parts}if("@"===i)return[new A(t,e.slice(1),n.eventContext)];if("?"===i)return[new b(t,e.slice(1),s)];return new y(t,e,s).parts}handleTextExpression(t){return new w(t)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
"undefined"!=typeof window&&(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.3.0");const k=(t,...e)=>new v(t,e,"html",S),H=(t,e,s,n)=>k`
	<label>
...
`,P=document.getElementById("app");!function t(e,s,i){e<s&&requestAnimationFrame(n=>t(e+Math.min(n-i,s-e),s,n)),((t,e,s)=>{let i=C.get(e);void 0===i&&(n(e,e.firstChild),C.set(e,i=new w(Object.assign({templateFactory:M},s))),i.appendInto(e)),i.setValue(t),i.commit()})(H(e,s,s=>t(e,s.target.value,i),()=>t(0,s,performance.now())),P)}(0,5e3,performance.now())}();