 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */;const $=new class{handleAttributeExpressions(t,e,s,n){const i=e[0];if("."===i){return new b(t,e.slice(1),s).parts}if("@"===i)return[new A(t,e.slice(1),n.eventContext)];if("?"===i)return[new V(t,e.slice(1),s)];return new N(t,e,s).parts}handleTextExpression(t){return new w(t)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
"undefined"!=typeof window&&(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.3.0");((t,e,s)=>{let i=C.get(e);void 0===i&&(n(e,e.firstChild),C.set(e,i=new w(Object.assign({templateFactory:M},s))),i.appendInto(e)),i.setValue(t),i.commit()})(((t,...e)=>new v(t,e,"html",$))` <div>Hello World!</div> `,document.getElementById("app"))}();