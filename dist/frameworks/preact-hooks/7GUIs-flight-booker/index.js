(function () {
	...
	function useDate(initialDate) {
	  var _useState = c$1(initialDate),
	      date = _useState[0],
	      setDate = _useState[1];

	  var _useState2 = c$1(null),
	      error = _useState2[0],
	...
	function App() {
	  var _useState3 = c$1(oneWayFlight),
	...
	I(h(App, null), document.getElementById("app"));
