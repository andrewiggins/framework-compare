(function () {
	...
	function useDate(initialDate) {
	  var _useState = m$1(initialDate),
	      date = _useState[0],
	      setDate = _useState[1];

	  var _useState2 = m$1(null),
	      error = _useState2[0],
	...
	function App() {
	  var _useState3 = m$1(oneWayFlight),
	...
	H(h(App, null), document.getElementById("app"));
