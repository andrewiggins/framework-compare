(function () {
	...
	function App() {
	  ...
	  var _useDate = useDate(initialDate),
	      ...
	      departingError = _useDate[1],
	      setDeparting = _useDate[2];

	  var _useDate2 = useDate(initialDate),
	      returning = _useDate2[0],
	      returningError = _useDate2[1],
	      setReturning = _useDate2[2];
	  ...
	  var isBookDisabled = departingError || returningError;

	  function bookFlight() {
	    var type = tripType === returnFlight ? "return" : "one-way";
	    var message = "You have booked a " + type + " flight, departing " + departing;
	...
	A(c(App, null), document.getElementById("app"));
