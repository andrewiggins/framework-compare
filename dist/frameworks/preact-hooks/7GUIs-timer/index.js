	...
	function App() {
	  ...
	  v$1(function () {
	    if (elapsed < duration) {
	      ...
	      var timeToAdd = Math.min(now - lastRenderTime, duration - elapsed);
	      setElapsed(function (prevElapsed) {
	        return prevElapsed + timeToAdd;
	      });
	      setLastRenderTime(now);
	    }
	  }, [elapsed, duration, lastRenderTime]);
	  return c(h, null, c("label", null, "Elapsed time: ", c("progress", {
	    value: elapsed / duration
	  })), c("div", {
	    "class": "elapsed"
	  }, (elapsed / 1000).toFixed(1), "s"), c("label", null, "Duration:", " ", c("input", {
	    type: "range",
	    min: "1",
	    max: "20000",
	    value: duration,
