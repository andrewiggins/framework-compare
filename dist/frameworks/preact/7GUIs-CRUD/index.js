(function () {
  ...
  function PersonSelect(_ref) {
    ...
    return v("div", {
      ...
      "class": "form-label"
    }, "Select a person to edit:"), v("select", {
      size: 5,
      onChange: onChange,
      "class": "form-select"
  ...
  var App = /*#__PURE__*/function (_Component) {
    ...
    _proto.render = function render(props, state) {
      ...
      }, v("legend", null, "People manager"), v(FilterInput, {
        value: state.filter,
  ...
  O(v(App, null), document.getElementById("app")); // Tests:
