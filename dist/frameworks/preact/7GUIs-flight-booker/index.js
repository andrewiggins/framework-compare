(function () {
  ...
  function (_Component) {
    ...
    _proto.updateDate = function updateDate(dateType, newDate) {
      var _this$setState;
      ...
      this.setState((_this$setState = {}, _this$setState[dateType] = newDate, _this$setState[dateType + "Error"] = errorMsg, _this$setState));
    };

    _proto.bookFlight = function bookFlight() {
      var type = this.state.tripType === returnFlight ? "return" : "one-way";
      var message = "You have booked a " + type + " flight, departing " + this.state.departing;
    ...
    _proto.render = function render(props, state) {
      ...
      var returningError = state.returningError;

      if (state.departingError == null && returningError == null && state.tripType == returnFlight && state.returning < state.departing) {
