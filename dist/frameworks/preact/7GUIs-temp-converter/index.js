(function () {
  ...
  function (_Component) {
    ...
    _proto.setBothFromC = function setBothFromC(value) {
      this.setState({
        c: value,
    ...
    _proto.setBothFromF = function setBothFromF(value) {
      this.setState({
        f: value,
    ...
    _proto.render = function render(props, state) {
      ...
      return c(h, null, c("input", {
        value: state.c,
        onInput: function onInput(e) {
          return _this2.setBothFromC(e.target.value);
        },
        type: "number"
      }), " ", "\xB0c =", " ", c("input", {
        value: state.f,
        onInput: function onInput(e) {
          return _this2.setBothFromF(e.target.value);
        },
        type: "number"
      }), " ", "\xB0f");
    };
