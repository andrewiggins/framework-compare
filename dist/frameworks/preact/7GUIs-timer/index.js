(function () {
  ...
  function (_Component) {
    ...
    _proto.animationFrame = function animationFrame() {
      ...
      var timeToAdd = Math.min(now - this.state.lastRenderTime, this.state.duration - this.state.elapsed);
      this.frame = null;
      this.setState({
    ...
    _proto.render = function render(props, state) {
      ...
      return c(h, null, c("label", null, "Elapsed time: ", c("progress", {
        ...
        "class": "elapsed"
      }, (state.elapsed / 1000).toFixed(1), "s"), c("label", null, "Duration:", " ", c("input", {
        type: "range",
        min: "1",
        max: "20000",
