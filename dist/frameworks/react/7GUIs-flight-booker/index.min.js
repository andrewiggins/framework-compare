(function(){'use strict';function _inheritsLoose(subClass, superClass) {
...
unstable_ConcurrentMode:x,unstable_Profiler:u,__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED:{ReactCurrentDispatcher:I,ReactCurrentOwner:J,assign:objectAssign}},Y={default:X},Z=Y&&X||Y;var react_production_min=Z.default||Z;var react = createCommonjsModule(function (module) {
...
var scheduler_production_min_16 = scheduler_production_min.unstable_getFirstCallbackNode;var scheduler = createCommonjsModule(function (module) {
...
function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    var _this$state = this.state,
        tripType = _this$state.tripType,
        departing = _this$state.departing,
        departingError = _this$state.departingError,
        returning = _this$state.returning,
        returningError = _this$state.returningError;
