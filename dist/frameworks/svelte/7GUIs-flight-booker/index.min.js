...
var returnFlight = "return";function create_fragment(ctx) {
...
function (_SvelteComponent) {
  ...
  return TripType;
}(SvelteComponent);function create_if_block(ctx) {
  var p, t;
  return {
    c: function c() {
      p = element("p");
...
function (_SvelteComponent) {
  ...
  return DateEntry;
}(SvelteComponent);function create_fragment$2(ctx) {
...
function (_SvelteComponent) {
  ...
  return FlightBooker;
}(SvelteComponent);new FlightBooker({
