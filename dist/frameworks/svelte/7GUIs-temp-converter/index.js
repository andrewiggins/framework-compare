(function () {
  ...
  function instance($$self, $$props, $$invalidate) {
    ...
    function setBothFromC(value) {
      $$invalidate(0, c = +value);
      $$invalidate(1, f = +(32 + 9 / 5 * c).toFixed(1));
    }

    function setBothFromF(value) {
      $$invalidate(1, f = +value);
      $$invalidate(0, c = +(5 / 9 * (f - 32)).toFixed(1));
    }
    ...
    return [c, f, setBothFromC, setBothFromF, input_handler, input_handler_1];
  }

  var TempConv = /*#__PURE__*/function (_SvelteComponent) {
