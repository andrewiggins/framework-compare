(function () {
    ...
    const _hoisted_2 = /*#__PURE__*/createVNode("label", {
      class: "form-label",
      for: "trip-type"
    }, "Trip type", -1 /* HOISTED */);
    const _hoisted_3 = /*#__PURE__*/createVNode("option", { value: "one-way" }, "one-way flight", -1 /* HOISTED */);
    const _hoisted_4 = /*#__PURE__*/createVNode("option", { value: "return" }, "return flight", -1 /* HOISTED */);
    ...
    function render(_ctx, _cache, $props, $setup, $data, $options) {
      return (openBlock(), createBlock("div", _hoisted_1, [
        ...
        createVNode("select", {
          id: "trip-type",
          class: "form-select",
          onInput: _cache[1] || (_cache[1] = e => $props.onSetTripType(e.target.value))
        }, [
          _hoisted_3,
          _hoisted_4
        ], 32 /* HYDRATE_EVENTS */)
    ...
    script.__file = "src/7GUIs-flight-booker/TripType.vue";
    ...
    function render$1(_ctx, _cache, $props, $setup, $data, $options) {
      return (openBlock(), createBlock("div", {
        class: ["form-group", { 'has-error': $props.errorMsg }]
      }, [
        createVNode("label", {
          class: "form-label",
          for: $props.label + '-date'
        }, toDisplayString($props.label), 9 /* TEXT, PROPS */, ["for"]),
        createVNode("input", {
          id: $props.label + '-date',
          class: "form-input",
          type: "text",
          value: $props.date,
          onInput: _cache[1] || (_cache[1] = e => $props.onSetDate(e.target.value)),
          disabled: $props.disabled || false
        }, null, 40 /* PROPS, HYDRATE_EVENTS */, ["id", "value", "disabled"]),
        ($props.errorMsg)
          ? (openBlock(), createBlock("p", _hoisted_1$1, toDisplayString($props.errorMsg), 1 /* TEXT */))
          : createCommentVNode("v-if", true)
      ], 2 /* CLASS */))
    }

    script$1.render = render$1;
    script$1.__file = "src/7GUIs-flight-booker/DateEntry.vue";
    ...
    var script$2 = {
    	components: { TripType: script, DateEntry: script$1 },
    	data() {
    ...
    function render$2(_ctx, _cache, $props, $setup, $data, $options) {
      const _component_TripType = resolveComponent("TripType");
      const _component_DateEntry = resolveComponent("DateEntry");

      return (openBlock(), createBlock(Fragment, null, [
        createVNode(_component_TripType, {
          onSetTripType: _cache[1] || (_cache[1] = newTripType => ($data.tripType = newTripType))
        }),
        createVNode(_component_DateEntry, {
          label: "Departing",
          date: $data.departing,
          errorMsg: $options.departingError,
          onSetDate: _cache[2] || (_cache[2] = newDate => ($data.departing = newDate))
        }, null, 8 /* PROPS */, ["date", "errorMsg"]),
        createVNode(_component_DateEntry, {
          label: "Returning",
          date: $data.returning,
          errorMsg: $options.returningError,
          onSetDate: _cache[3] || (_cache[3] = newDate => ($data.returning = newDate)),
          disabled: $data.tripType == $data.oneWayFlight
        }, null, 8 /* PROPS */, ["date", "errorMsg", "disabled"]),
        createVNode("div", _hoisted_1$2, [
          createVNode("button", {
            class: "btn btn-primary",
            onClick: _cache[4] || (_cache[4] = (...args) => ($options.bookFlight && $options.bookFlight(...args))),
            disabled: $options.isBookDisabled
          }, " book ", 8 /* PROPS */, ["disabled"])
        ])
      ], 64 /* STABLE_FRAGMENT */))
    }

    script$2.render = render$2;
    script$2.__file = "src/7GUIs-flight-booker/FlightBooker.vue";
