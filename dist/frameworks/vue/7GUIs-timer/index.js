(function () {
    ...
    const _hoisted_1 = /*#__PURE__*/createTextVNode(" Elapsed time: ");
    const _hoisted_2 = { class: "elapsed" };
    const _hoisted_3 = /*#__PURE__*/createTextVNode(" Duration: ");
      ...
      return (openBlock(), createBlock(Fragment, null, [
        createVNode("label", null, [
          ...
          createVNode("progress", {
            value: _ctx.elapsed / _ctx.duration
          }, null, 8 /* PROPS */, ["value"])
        ]),
        createVNode("div", _hoisted_2, toDisplayString(_ctx.elapsedFormatted), 1 /* TEXT */),
        createVNode("label", null, [
          _hoisted_3,
          withDirectives(createVNode("input", {
            type: "range",
            "onUpdate:modelValue": _cache[1] || (_cache[1] = $event => (_ctx.duration = $event)),
            min: "1",
            max: "20000"
          }, null, 512 /* NEED_PATCH */), [
            [vModelText, _ctx.duration]
          ])
        ]),
        createVNode("div", null, [
          createVNode("button", {
            class: "btn btn-primary",
            onClick: _cache[2] || (_cache[2] = (...args) => (_ctx.reset(...args)))
          }, "Reset")
        ])
      ], 64 /* STABLE_FRAGMENT */))
    }
    ...
    script.__file = "src/7GUIs-timer/Timer.vue";
