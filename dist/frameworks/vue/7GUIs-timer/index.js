      ...
      return (openBlock(), createBlock(Fragment, null, [
        createVNode("label", null, [
          ...
          createVNode("progress", {
            value: $data.elapsed / $data.duration
          }, null, 8 /* PROPS */, ["value"])
        ]),
        createVNode("div", _hoisted_2, toDisplayString($options.elapsedFormatted), 1 /* TEXT */),
        createVNode("label", null, [
          _hoisted_3,
          withDirectives(createVNode("input", {
            type: "range",
            "onUpdate:modelValue": _cache[1] || (_cache[1] = $event => ($data.duration = $event)),
            min: "1",
            max: "20000"
          }, null, 512 /* NEED_PATCH */), [
            [vModelText, $data.duration]
          ])
        ]),
